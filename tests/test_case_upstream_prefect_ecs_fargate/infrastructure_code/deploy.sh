...
echo "=== Prefect ECS Fargate Deployment ==="
echo ""
...
echo "Check CloudWatch logs at /ecs/tracer-prefect for Prefect server status."
echo ""
echo "To update the trigger Lambda with the Prefect API URL:"
echo "1. Get the ECS task public IP from the AWS Console"
echo "2. Update the PREFECT_API_URL environment variable in the trigger Lambda"
